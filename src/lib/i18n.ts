...
const translations: Record<Language, Translations> = {
  en: {
    ...
    aiTyping: 'Thinking...',
    aiGreeting: 'Hello! 🌸 Welcome to the Cosmic Garden. What mood or blessing would you like to share today?',
    aiAskFlower: "That's wonderful! ✨ What kind of flower would you like to plant? You can describe it, or I'll choose one that matches your mood~",
    aiAskName: 'Beautiful choice! 🌷 Would you like to sign your name on this flower?',
    aiThankYou: 'Perfect! 🌱 Planting your flower in the garden now...',
  ...
  zh: {
    ...
    aiTyping: '思考中...',
    aiGreeting: '你好！🌸 欢迎来到宇宙花园。今天想分享什么心情或祝福呢？',
    aiAskFlower: '真棒！✨ 想种一朵什么样的花呢？可以描述一下，或者让我根据你的心情来选择~',
    aiAskName: '很美的选择！🌷 想在这朵花上留下你的名字吗？',
    aiThankYou: '好的！🌱 正在花园里种下你的花朵...',
    aiPlanting: '正在种植您的花朵...',
    skipName: '保持匿名',
    sendMessage: '发送',
  ...
  ja: {
    ...
    aiTyping: '考え中...',
    aiGreeting: 'こんにちは！🌸 コスミックガーデンへようこそ。今日はどんな気持ちや祝福を共有したいですか？',
    aiAskFlower: '素敵ですね！✨ どんな花を植えたいですか？説明してもいいし、気持ちに合った花を選んであげますよ〜',
    aiAskName: '美しい選択です！🌷 この花にお名前を残しますか？',
    aiThankYou: 'ありがとう！🌱 庭に花を植えています...',
    aiPlanting: '花を植えています...',
    skipName: '匿名のまま',
    sendMessage: '送信',
